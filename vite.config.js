...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      injectRegister: "auto",
      workbox: { cleanupOutdatedCaches: false, sourcemap: true, navigateFallbackDenylist: [/api\.amtraker\.com/g] },
      includeAssets: ["**/*"],
      ...
      manifest: {
        ...
        description:
          "Amtraker is a free, open source, and easy to use Train Tracker for Amtrak, Brightline, and VIA Rail!",
        lang: "en",
        ...
        protocol_handlers: [{ protocol: "web+amtraker", url: "https://amtraker.com/trains/%s" }],
