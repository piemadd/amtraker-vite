...
export async function onRequest(context) {
  ...
  if (!pathname.startsWith('/atlas')) return res; // not entirely sure how we got here tbh
  ...
  const infoRes = await fetch(`http://api.amtraker.com/v3/trains/${code}`, {
    headers: {
      'User-Agent': "AmtrakerViteWorker/v3.21.11 (+https://amtraker.com)",
      'Amtraker-Version': "v3.21.11",
    }
  });
  ...
  ogtag = `
    <meta property="og:title" content="Atlas - Amtraker" />
    <meta property="og:description" content="Track your trips with Amtraker Atlas!" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="${request.url}" />
    <meta property="og:image" content="https://amtraker.com/content/images/amtraker_cover.webp" />
