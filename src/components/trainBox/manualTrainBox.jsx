  ...
  return loading ? (
    ...
    >
      <div>
        ...
        >
          {train.trainNum}
          {!train.onlyOfTrainNum ? ` (${train.trainID.split("-")[1]})` : ""}
        </span>
        &nbsp;
        <span>{train.routeName}</span>
        {overrideEventCode ? null : (
          <>
            &nbsp;
            <span
      ...
      {overrideEventCode ? (
        <>
          ...
          {currentStation.platform.length > 0 ? (
            <p>[Track {currentStation.platform}]</p>
          ) : null}
        </>
      ) : (
        <p>
